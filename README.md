...
Hi! I created this script to make resizing / partition as easy as possible on your Ubuntu phone. After running this script, your / partition will resize from 2.0G to approx. 7.7G. This script only works if your / partition name is /dev/loop0 ! (In future versions of this script, I will also add an option to resize other partitions)
